	...
	public function index() {
		...
		if ($product_info) {
			...
			$data['button_upload'] = $this->language->get('button_upload');
						...
						$data['email_label'] = $this->language->get('email_label');			
						$data['notify_me_label'] = $this->language->get('notify_me_label');			
						$data['product_is_not_available'] = $this->language->get('product_is_not_available');			
